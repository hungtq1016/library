            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="/admin/major" class="btn btn-primary d-none d-sm-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <a href="/admin/major" class="btn btn-primary d-sm-none btn-icon">
                            <!-- SVG plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable" id="authorTable">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/major/<?php echo $set['major_id']?>">
                                                <?php echo $set['major_name']?>
                                            </a>
                                        </td>
                                        <td>
                                            <?php if($set['major_status'] ==6){?>
                                            <span class="badge bg-success me-1"></span>
                                            <?php echo $set['status_name'];}?>
                                            <?php if($set['major_status'] ==7){?>
                                            ...
                                            <span class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="http://localhost:8001/src/Controllers/major.php?action=invisible&id=<?php echo $set['major_id']?>">
                                                        Ẩn
                                                    </a>
                                                    <?php } if ($set['major_status'] == 7) {?>
                                                    <a class="dropdown-item"
                                                        href="http://localhost:8001/src/Controllers/major.php?action=visible&id=<?php echo $set['major_id']?>">
                                                        Hiện
                                                    </a>
                                                    <?php } ?>
                                                    <a class="dropdown-item" onclick=" return confirm('Bạn có chắc chắn muốn xóa?')"
                                                        href="http://localhost:8001/src/Controllers/major.php?action=delete&id=<?php echo $set['major_id']?>">
                                                        Xóa
                                                    </a>
                                                </div>
                                            </span>
