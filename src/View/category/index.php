            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="/category" class="btn btn-primary d-none d-sm-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <a href="/category" class="btn btn-primary d-sm-none btn-icon">
                            <!-- SVG plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <div class="col-auto">
                                            <span class="bg-primary text-white avatar">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="icon icon-tabler icon-tabler-hand-stop" width="24"
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable" id="authorTable">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="category/<?php echo $set['category_id']?>">
